...
const customData_1 = __webpack_require__(30);
            ...
            middleware: {
                provideCompletionItem: (document, position, context, token, next) => {
                    return Promise.resolve(next(document, position, context, token)).then((res) => {
                        ...
                        if (context.triggerKind == vscode_languageserver_protocol_1.CompletionTriggerKind.Invoked && option.input) {
...
function getCustomDataPathsInAllWorkspaces() {
    const dataPaths = [];
    let workspaceFolders = coc_nvim_1.workspace.workspaceFolders;
    if (!workspaceFolders) {
        return dataPaths;
    }
    workspaceFolders.forEach(wf => {
        const allCssConfig = coc_nvim_1.workspace.getConfiguration(undefined, wf.uri);
