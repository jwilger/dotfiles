...
const fs_1 = tslib_1.__importDefault(__webpack_require__(3));
...
function activate(context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        client.onReady().then(() => {
            ...
            client.onRequest(OpenESLintDocRequest.type, (params) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
const path_1 = tslib_1.__importDefault(__webpack_require__(4));
const fs_1 = tslib_1.__importDefault(__webpack_require__(3));
const which_1 = tslib_1.__importDefault(__webpack_require__(31));
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(32)
