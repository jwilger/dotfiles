...
(function (ValidationCode) {
    ...
    ValidationCode[ValidationCode["UNSUPPORTED_MODIFIER"] = 43] = "UNSUPPORTED_MODIFIER";
    ValidationCode[ValidationCode["DEPRECATED_MAINTAINER"] = 44] = "DEPRECATED_MAINTAINER";
    ValidationCode[ValidationCode["HEALTHCHECK_CMD_ARGUMENT_MISSING"] = 45] = "HEALTHCHECK_CMD_ARGUMENT_MISSING";
    ValidationCode[ValidationCode["FLAG_INVALID_FROM_VALUE"] = 46] = "FLAG_INVALID_FROM_VALUE";
    /**
     ...
     */
    ValidationCode[ValidationCode["JSON_IN_SINGLE_QUOTES"] = 47] = "JSON_IN_SINGLE_QUOTES";
    /**
     * The error code used if a WORKDIR instrction does not point to
     * an absolute path.
     */
    ValidationCode[ValidationCode["WORKDIR_IS_NOT_ABSOLUTE"] = 48] = "WORKDIR_IS_NOT_ABSOLUTE";
    /**
     * The error code used if a FROM instruction uses a variable to
     * reference its base image but the variable does not exist.
     */
    ValidationCode[ValidationCode["BASE_NAME_EMPTY"] = 49] = "BASE_NAME_EMPTY";
