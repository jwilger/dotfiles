...
elseif &t_Co == 256
  ...
  " -> Folding
  hi FoldColumn     ctermbg=26  ctermfg=16     cterm=none
  hi Folded         ctermbg=26  ctermfg=16     cterm=none
  ...
  " -> Spell
  hi SpellBad       ctermbg=234  ctermfg=208   cterm=underline
  hi SpellCap       ctermbg=22   ctermfg=208   cterm=underline
  hi SpellRare      ctermbg=24   ctermfg=208   cterm=underline
  hi SpellLocal     ctermbg=235  ctermfg=130   cterm=underline
  ...
  "
  " -> Visual Mode
  hi Visual         ctermbg=243    ctermfg=0   cterm=none 
  hi VisualNOS      ctermbg=243    ctermfg=0   cterm=none
  ...
  hi MatchParen     ctermbg=214  ctermfg=243   cterm=none
